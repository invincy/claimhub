document.addEventListener('DOMContentLoaded', function() {
    var particlesContainer = document.getElementById('particles');
        ...
        const PlanDB = (() => {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    request.onupgradeneeded = (e) => {
                        ...
                        if (!db.objectStoreNames.contains(STORE_NAME)) {
                            db.createObjectStore(STORE_NAME, { keyPath: 'plan' });
                        }
                    };
                    request.onsuccess = (e) => {
                        db = e.target.result;
            ...
            async function savePlan(plan, data) {
                const db = await openDB();
                return new Promise((resolve, reject) => {
                    const tx = db.transaction(STORE_NAME, 'readwrite');
                    tx.objectStore(STORE_NAME).put({ plan, data });
            ...
            async function getPlan(plan) {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    const req = tx.objectStore(STORE_NAME).get(plan);
        ...
        const PLAN_179 = {
          ...
          "46": {"12":91.05,"16":78.5,"20":NaN},
          "47": {"12":93.9,"16":80.75,"20":NaN},
          "48": {"12":96.95,"16":83.1,"20":NaN},
          "49": {"12":100.0,"16":85.55,"20":NaN},
          "50": {"12":103.3,"16":88.1,"20":NaN},
          "51": {"12":106.7,"16":90.8,"20":NaN},
          "52": {"12":110.3,"16":NaN,"20":NaN},
          "53": {"12":114.0,"16":NaN,"20":NaN},
          "54": {"12":117.8,"16":NaN,"20":NaN},
          "55": {"12":121.8,"16":NaN,"20":NaN},
          "56": {"12":125.85,"16":NaN,"20":NaN},
